<?php $title = get_the_title(); $error = is_404(); ?>
<footer <?php if($title == 'Contato' || $error == true){echo 'style="padding:20px 0;"';} ?>>
    <?php
        
        if($title != 'Contato' && $error === false){
...
<script src="http://maps.googleapis.com/maps/api/staticmap?center=-22.912869,-43.2289638
